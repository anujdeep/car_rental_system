...
<html>
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				<div class="logo"><a href="index.php"><font size="+5" color="#66FF00" face="Comic Sans MS, cursive">SAVAARI&emsp;</font><span id="loghead">we take you places</span></a></div>
		...
		<!-- Two -->
			<section id="two" class="wrapper post bg-img" data-bg="cab2.jpg">
				<div class="inner">
					<article class="box">
						<header>
							<h2><a href="signup.php">book your ticket now</a></h2>
                        </header>
